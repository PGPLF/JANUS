...
\title{\textbf{JWST High-Redshift Galaxies: \\
A Comparative Analysis of JANUS and $\Lambda$CDM Cosmologies}}

\author{
Patrick Guerin\thanks{Corresponding author: pg@gfo.bzh}\\
\small Independent Researcher\\
\small Brittany, France\\[1em]
\small \textit{Author contributions}: P.G. designed the study, performed all analyses,\\
\small developed the validation framework, and wrote the manuscript.\\[0.5em]
\small \textit{Funding}: This research received no specific grant from any funding agency.\\[0.5em]
\small \textit{Conflicts of interest}: The author declares no competing interests.\\[0.5em]
...
\begin{abstract}
We present a systematic analysis of 6,672 high-redshift ($z > 6.5$) galaxies observed by the James Webb Space Telescope (JWST), comparing predictions from the standard $\Lambda$CDM cosmology with the bimetric JANUS model. Using verified data from JADES DR2/DR3/DR4 and COSMOS-Web surveys, we perform Bayesian MCMC fitting of the UV luminosity function evolution. Our results show that JANUS predicts 15--25\% more cosmic time at $z > 10$, potentially alleviating the ``impossibly massive'' galaxy problem. We find best-fit parameters $H_0^{\rm JANUS} = 78.8 \pm 5.1$~\kms\,Mpc$^{-1}$ and $H_0^{\rm LCDM} = 71.4 \pm 5.0$~\kms\,Mpc$^{-1}$. Model comparison using information criteria reveals complex tensions: while \LCDM{} provides a better statistical fit ($\Delta\chi^2 = 2097$), it struggles to physically accommodate the observed abundance of massive galaxies at $z > 10$. This work establishes a methodological framework for cosmological model testing with JWST data.
\end{abstract}

\noindent\textbf{Keywords:} cosmology -- galaxies: high-redshift -- methods: statistical -- telescopes: JWST -- gravitation: bimetric
...
The James Webb Space Telescope (JWST) has revolutionized our understanding of the early Universe by detecting galaxies at redshifts $z > 10$ \citep{Finkelstein2022, Naidu2022, Labbe2023}. Several of these objects appear ``impossibly massive''---they contain more stellar mass than standard \LCDM{} cosmology allows given the available cosmic time \citep{Boylan-Kolchin2023}.
...
\begin{enumerate}
    ...
    \item \textbf{JADES DR4}: Spectroscopically confirmed sources with precision redshifts \citep{Curtis-Lake2025}.
...
We employ the \texttt{emcee} ensemble sampler \citep{Foreman-Mackey2013} with:
\begin{itemize}
...
Model comparison uses the Bayesian Information Criterion \citep{Kass1995}:
\begin{equation}
...
\midrule
$H_0$ [\kms\,Mpc$^{-1}$] & $78.8 \pm 5.1$ & $71.4 \pm 5.0$ \\
...
\begin{tabular}{lccc}
\toprule
$z$ & JANUS [Gyr] & \LCDM{} [Gyr] & $\Delta t$ \\
\midrule
8 & 0.75 & 0.64 & +110 Myr \\
10 & 0.58 & 0.47 & +110 Myr \\
12 & 0.46 & 0.37 & +90 Myr \\
14 & 0.38 & 0.30 & +80 Myr \\
\bottomrule
\end{tabular}
...
\begin{itemize}
    ...
    \item No need for extreme SFR ($> 1000$~\Msun{}\,yr$^{-1}$)
\end{itemize}

\subsection{Hubble Tension}

Our best-fit $H_0^{\rm JANUS} = 78.8$~\kms\,Mpc$^{-1}$ is consistent with local measurements \citep{Riess2022}, while $H_0^{\rm LCDM} = 71.4$~\kms\,Mpc$^{-1}$ lies between Planck CMB and local values. This suggests JANUS may naturally resolve the Hubble tension.
...
This work made use of Astropy \citep{Astropy2022}, NumPy \citep{Harris2020}, SciPy \citep{Virtanen2020}, Matplotlib \citep{Hunter2007}, and emcee \citep{Foreman-Mackey2013}.
...
% =============================================================================
% REFERENCES (ordre alphabétique par premier auteur)
% =============================================================================
...
\bibitem[Boylan-Kolchin(2023)]{Boylan-Kolchin2023}
Boylan-Kolchin, M.\ 2023,
Nature Astronomy, \textbf{7}, 731
...
\bibitem[Curtis-Lake et al.(2025)]{Curtis-Lake2025}
...
Petit, J.-P., \& d'Agostini, G.\ 2014,
Astrophys. Space Sci., \textbf{354}, 2106

\bibitem[Petit et al.(2022)]{Petit2022}
Petit, J.-P., d'Agostini, G., \& Debergh, N.\ 2022,
Mod. Phys. Lett. A, \textbf{37}, 2250006

\bibitem[Petit et al.(2024)]{Petit2024}
Petit, J.-P., Esculier, T., \& d'Agostini, G.\ 2024,
Eur. Phys. J. C, \textbf{84}, 879
